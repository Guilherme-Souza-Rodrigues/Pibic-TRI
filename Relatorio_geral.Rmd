...
```{r , echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, fig.cap='Notas e Acertos por Turma', fig.subcap=c('Nota Média das Turmas por Prova', 'Proporção de acertos por tema na Prova 1', 'Proporção de acertos por tema na Prova 2', 'Proporção de acertos por tema na Prova 3'), out.width='.49\\linewidth', fig.asp=1, fig.ncol=2, fig.nrow=2}
if (!require("pacman")) install.packages("pacman")
