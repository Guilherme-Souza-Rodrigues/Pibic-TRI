...
```{r , echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, fig.cap='Notas e Acertos por Turma', fig.subcap=c('Primeiro', 'Segundo'), out.width='.49\\linewidth', fig.asp=1, fig.ncol=2, fig.nrow=2}
if (!require("pacman")) install.packages("pacman")
